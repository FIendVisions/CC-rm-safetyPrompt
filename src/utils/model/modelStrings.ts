...
async function getBedrockModelStrings(): Promise<ModelStrings> {
  ...
  // user's inference profile list (e.g. "claude-opus-4-8" matches
  // "eu.anthropic.claude-opus-4-8-v1"). Fall back to the hardcoded bedrock ID
 ...
 * model ID (e.g. "claude-opus-4-8") and map to arbitrary provider-specific
